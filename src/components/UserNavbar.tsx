      ...
      <div className="dashboard-top-banner">
        ...
        <div>
          <div className="dashboard-main-links">
            <Link to="/dashboard" className="dashboard-main-link dashboard-main-link-active">
              Home
            </Link>
            <Link to="/policies" className="dashboard-main-link">
              Policies
            </Link>
            <Link to="/quotes" className="dashboard-main-link">
              Quotes
            </Link>
